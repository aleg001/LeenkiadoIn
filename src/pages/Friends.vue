<template>
  <div class="friend-component">
    ...
    <div class="friend-component__search-bar">
      <input
        type="text"
        v-model="searchQuery"
    ...
    <ul class="friend-component__list">
      <li
    ...
    <h2 class="friend-component__title">Mara que tal vez conozcas</h2>
    <ul class="friend-component__recommendations">
      <li
