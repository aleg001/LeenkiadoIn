<template>
  <div class="flex w-full items-center justify-center px-[5rem]">
    <div class="flex max-w-[500px] mr-[2rem]">
      <h2 style="color: #49738f" class="text-[3rem] font-normal">
        Bienvenido a la mejor red social <br />
        <h3 style="color: #49738f" class="text-[1rem] font-normal">
          <br />Desarrollado por:<br />
          Alecraft<br />
          Uncle Pete <br />Racso
        </h3>
      </h2>
